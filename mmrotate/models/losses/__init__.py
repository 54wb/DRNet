...
from .confusion_minimized_loss import ConfusionMinimizedLoss
...
__all__ = [
    ...
    'SpatialBorderLoss', 'LabelSmoothLoss', 'convert_to_one_hot',
    'weight_reduce_loss', 'ConfusionMinimizedLoss'
]
